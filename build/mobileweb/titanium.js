...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by lpaulger",
		deployType: "development",
		description: "not specified",
		guid: "f54e7ea9-a279-4245-b879-357210623db9",
		id: "gitTogether",
		name: "gitTogether",
		names: {},
		publisher: "lpaulger",
		url: "http://gitTogether.lucaspaulger.com",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","NISLjHEqLUASbigbnGjXvXdK13KhvGyS");
p.setString("acs-api-key-development","B8NoWxug9E8STpoCo6JvYS083wxCjhH7");
p.setString("acs-oauth-secret-development","cehtil08NQxHTO3wNidEFiAjCiktnfLR");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","BXbFl9h6XOzTkDEGWdGo8fEupw7VeOpF");
p.setString("acs-oauth-key-development","fPXdX7Y3v1T85qZmMkbg9csnk1BrbGEA");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","Zk92RqDCrMye9ZfuZL98A01ieTYAJYNt");
});
