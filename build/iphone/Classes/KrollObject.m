 ...
 * Copyright (c) 2009-2011 by gitTogether, Inc. All Rights Reserved.
...
//@interface gitTogetherObject : NSObject
//@end

@interface gitTogetherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[gitTogetherObject class]])
		{
			for (NSString *key in [[(gitTogetherObject*)o modules] allKeys])
			{
