...
/**
 The base class for all gitTogether modules
 */
...
/**
 gitTogether Platform calls this method on startup.
 */
-(void)startup;

/**
 gitTogether Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 gitTogether Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 gitTogether Platform calls this method on resume.
 @param sender The sender of the event.
 */
