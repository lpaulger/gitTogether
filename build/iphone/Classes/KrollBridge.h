...
@interface gitTogetherObject : KrollCoverageObject {
#else
@interface gitTogetherObject : KrollObject {
#endif
@private
...
extern NSString * gitTogether$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	gitTogetherObject *_gittogether;
	BOOL shutdown;
