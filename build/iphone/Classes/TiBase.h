...
// in simulator we redefine to format for gitTogether Developer console
...
{\
	NSString * exceptionName = [@"org.gittogether." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gittogether";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIgitTogetherNativeItemNone = -1, 
	UIgitTogetherNativeItemSpinner = -2,
	UIgitTogetherNativeItemProgressBar = -3,
	
	UIgitTogetherNativeItemSlider = -4,
	UIgitTogetherNativeItemSwitch = -5,
	UIgitTogetherNativeItemMultiButton = -6,
	UIgitTogetherNativeItemSegmented = -7,
	
	UIgitTogetherNativeItemTextView = -8,
	UIgitTogetherNativeItemTextField = -9,
	UIgitTogetherNativeItemSearchBar = -10,
	
	UIgitTogetherNativeItemPicker = -11,
	UIgitTogetherNativeItemDatePicker = -12,
	
	UIgitTogetherNativeItemInfoLight = -13,
	UIgitTogetherNativeItemInfoDark = -14,
	
	UIgitTogetherNativeItemDisclosure = -15,
	
	UIgitTogetherNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all gitTogether instances of
